...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "TARGET_HZ" -parent ${Page_0}
...
proc update_PARAM_VALUE.TARGET_HZ { PARAM_VALUE.TARGET_HZ } {
	# Procedure called to update TARGET_HZ when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.TARGET_HZ { PARAM_VALUE.TARGET_HZ } {
	# Procedure called to validate TARGET_HZ
	return true
}
...
proc update_MODELPARAM_VALUE.TARGET_HZ { MODELPARAM_VALUE.TARGET_HZ PARAM_VALUE.TARGET_HZ } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.TARGET_HZ}] ${MODELPARAM_VALUE.TARGET_HZ}
}
