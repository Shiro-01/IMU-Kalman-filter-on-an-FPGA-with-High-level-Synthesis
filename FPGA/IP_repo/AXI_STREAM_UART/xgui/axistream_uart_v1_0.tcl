...
proc init_gui { IPINST } {
  ...
  set PARITY_MODE [ipgui::add_param $IPINST -name "PARITY_MODE" -parent ${Page_0}]
  set_property tooltip {0=None, 1=Even, 2=Odd} ${PARITY_MODE}
...
proc update_PARAM_VALUE.PARITY_MODE { PARAM_VALUE.PARITY_MODE } {
	# Procedure called to update PARITY_MODE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PARITY_MODE { PARAM_VALUE.PARITY_MODE } {
	# Procedure called to validate PARITY_MODE
	return true
}
...
proc update_MODELPARAM_VALUE.PARITY_MODE { MODELPARAM_VALUE.PARITY_MODE PARAM_VALUE.PARITY_MODE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PARITY_MODE}] ${MODELPARAM_VALUE.PARITY_MODE}
}
